...
let progress = Promise.all([d3.json("https://raw.githubusercontent.com/vanHeemstraSystems/quarto-revealjs/main/data/progress.json")])
  .then(
    function success(allData) {
      const progressData = allData[0];
