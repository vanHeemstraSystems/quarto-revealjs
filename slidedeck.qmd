...
const consumer = () => {  
    promise.finally(() => {
      ...
      // console.log('data["progress"]: ', data["progress"]);  // DISCARD
      // console.log('data.["progress"]: ', data.["progress"]); // DISCARD
      console.log('data.progress: ', data.progress);
      // console.log("data[0]: ", data[0]); // DISCARD
      // console.log("data.[0]: ", data.[0]); // DISCARD
      // console.log("data[0].start: ", data[0].start); // DISCARD
      console.log("data.progress.start: ", data.progress.start);
      // console.log("data[0].end: ", data[0].end); // DISCARD
      ...
      let progressStartValue = 0,    
          progressEndValue = 90,
          progressLoadedEndValue = data.progress.end,
          speed = 100;
